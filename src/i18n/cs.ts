...
export default {
    ...
    messages: {
        ...
        "vocabulary.summary.export.ttl.title": "Export do RDF serializace Turtle",
        ...
        "term.metadata.assignments.suggestedOccurrence.help": "Navržený výskyt reprezentuje výskyt pojmu navržený systémem, např. na základě automatizované analýzy obsahuje.",
        ...
        'annotator.legend.loading': 'Načítavající anotace',
        'annotator.legend.loading.tooltip': 'Annotation is still loading',
        'annotator.legend.confirmed.unknown.term': 'Potvrzený výskyt neznámého pojmu',
        'annotator.legend.confirmed.unknown.term.tooltip': 'Occurrence of a term was identified by a user but the term was not created in a vocabulary yet',
        'annotator.legend.confirmed.existing.term': 'Potvrzený výskyt existujícího pojmu',
        'annotator.legend.confirmed.existing.term.tooltip': 'Occurrence of a term was identified by a user and the term is in the vocabulary',
        'annotator.legend.confirmed.missing.term': 'Potvrzený výskyt chybějícího pojmu',
        'annotator.legend.confirmed.missing.term.tooltip': 'Occurrence of a term was accepted by a user but the vocabulary related to the term is missing',
        'annotator.legend.proposed.unknown.term': 'Navrhovaný výskyt neznámého pojmu',
        'annotator.legend.proposed.unknown.term.tooltip': 'Occurrence of a term was identified by the text analysis service but not assigned to a term in the vocabulary yet',
        'annotator.legend.proposed.existing.term': 'Navrhovaný výskyt existujícího pojmu',
        'annotator.legend.proposed.existing.term.tooltip': 'Occurrence of a term was identified by the text analysis service and the term is in the vocabulary',
        'annotator.legend.proposed.missing.term': 'Navrhovaný výskyt chybějícího pojmu',
        'annotator.legend.proposed.missing.term.tooltip': 'Occurrence of a term was accepted by the text analysis service but vocabulary related to the term is missing',
