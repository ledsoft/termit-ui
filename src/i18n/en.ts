...
export default {
    ...
    messages: {
        ...
        'annotator.legend.loading': 'Loading Annotation',
        'annotator.legend.loading.tooltip': 'Annotation is still loading',
        'annotator.legend.proposed.loading.tooltip': 'Proposed annotation is still loading',
        'annotator.legend.confirmed.unknown.term': 'Confirmed Occurrence of an Unknown Term',
        'annotator.legend.confirmed.unknown.term.tooltip': 'Occurrence of a term was identified by a user but the term was not created in a vocabulary associated to this document yet',
        'annotator.legend.confirmed.existing.term': 'Confirmed Occurrence of an Existing Term',
        'annotator.legend.confirmed.existing.term.tooltip': 'Occurrence of a term was identified by a user and the term is in a vocabulary associated to this document',
