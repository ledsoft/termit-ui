                ...
                <Row>
                    <Col xs={{size: "auto", offset: 4}}>
                        <ButtonToolbar>
                            ...
                            <Button id="users-unlock-cancel" color="secondary" size="sm" onClick={props.onCancel}>
                                {props.i18n("cancel")}
                            </Button>
                        </ButtonToolbar>
                    </Col>
