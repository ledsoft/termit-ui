...
describe('Message', () => {
    ...
    it('displays alert with specified message text', () => {
        ...
        const wrapper = mountWithIntl(<Message message={message} dismissMessage={dismissMessage} i18n={i18n}
    ...
    it('sets timer to dismiss message after configured timeout', () => {
        const message: MessageModel = new MessageModel({message: 'Error message'});
        mountWithIntl(<Message message={message} dismissMessage={dismissMessage} i18n={i18n}
                               formatMessage={formatMessage}/>);
